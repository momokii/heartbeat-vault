        ...
        <form className="space-y-4" onSubmit={addRecipient} noValidate>
          <fieldset className="space-y-3">
            ...
            <FieldGuidance
              ...
              result="The email provider may retry; its receipt is recorded for this release."
            />
            <label className="flex items-start gap-2 text-sm">
              <input
                type="radio"
            ...
            <FieldGuidance
              ...
              result="The endpoint can receive a retry; its successful receipt is recorded."
            />
            <label className="flex items-start gap-2 text-sm">
              <input
                type="radio"
            ...
            <FieldGuidance
              ...
              result="Telegram may retry delivery; its Bot API receipt is recorded."
            />
          </fieldset>
          <div className="space-y-2">
            ...
            <FieldGuidance
              ...
              description="This is where the selected channel sends its release notice."
              example="recipient@example.com, https://hooks.example.com/heartbeat, or -1001234567890"
              result="The invitation is sent to this address and must be accepted before arming."
            />
          </div>
          <FieldGuidance
            ...
            result="An accepted invitation satisfies one arming prerequisite."
          />
          {state.message ? (
