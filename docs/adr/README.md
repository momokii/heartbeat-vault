...
| 003 | Fail safe default plus per vault opt in | Proposed | — |
| 004 | Clock contract, DB time, skew budget, CLOCK UNCERTAIN | Proposed | — |
...
ADRs 003 through 006 and 009 through 010 remain Proposed and are tracked in `docs/DESIGN.md` §9. ADRs 007 and 008 landed in T6.1 as direction only, implementation DEFERRED.
